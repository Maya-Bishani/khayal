...
const electricityWorks = [
  ...
  const FinishingWorks = [
    ...
    [
        ...
        "صرف تكيفات" ,
        " تاسيس بانيو أو كابينة شور أو جاكوزي",
    ],
    [
        "عمل صرف أمطار في البلكونه ",
        "تأسيس و صرف مكان حوض سمك أو نافوره علي حسب طلب العميل ",
        "تأسيس أجهزه استشعار التسرب ",
    ]
    ,
  ...
  const sections = [
    {
      ...
      items: [
        ...
        "الأعمال تشمل تركيب الاسبوتات والليد",
        "كناوف اخضر للحمامات",
        "كناوف احمر للمطابخ",
      ],
    },
    {
      title: "أعمال النجارة",
      items: [
        "باب شقه مستورد تركي  11 مم بقفل اسمارت 3 اقفال عادي ",
  ...
  ,
  {
    ...
    items: [
      "توريد و تركيب سيراميك كامل الريسبشن و الطرق ارضيات لا يتعدي سعر المتر   500 جنية ",
      "توريد و تركيب سيراميك باقي الوحده ارضيات وحوائط  لا يتعدي سعر المتر 400 جنية ",
  ...
  },
  {
    ...
    items: [
      ...
      "جانب بديل خشب لا يتعدي 5 متر",
      "عمل بانو جبس في الريسبشن و الطرقه",
      "عمل خلفيه 3d  في اوضه الاطفال على حسب طلب العميل",
  ...
  },
  {
    title:"الرخام",
    items:[
      "يتم استبدال السيراميك  بالرخام و حساب التكلفه والفرق على العميل "
    ]
  },
  {
    title:"الفريون",
    items:[
        "توريد و تركيب خامات PVC  جنوب افريقي لزوم عمل ثلاث مخارج تكييف بحد اقصي 8 متر للمسار  الواحد او 24 متر اجمالي الوحده "
    ]
  }
      ...
      >
       ...
       <div className="flex space-x-2 mt-5 items-center text-white " >
        ...
        <div className="flex items-center text-white space-x-1">
          <img src={verify} alt="check"/>
          <p className="text-sm md:text-base font-normal">تشطيب السباكه قاعده و حوض بحد اقصي 12000 جنية للحمام الواحد بحد اقصي 2 حمام </p>

        </div>
        <div className="flex items-center text-white space-x-1 ">
          <img src={verify} alt="check"/>
          <p className="text-sm md:text-base font-normal">تركيب خلاطات للحمام و المطبخ بحد اقصي 12000جنية </p>
        </div>
        <div className="flex text-white items-center space-x-1">
          <img src={gift}  className="w-6" alt="gift"/>
          <p className="text-sm md:text-base font-normal">هدية مراية ليد في الحمام والريسبشن</p>
        </div>
