...
export default function Vip({ index, openIndex, setOpenIndex }) {
  ...
  const electricityWorks = [
    ["تأسيس أسلاك سويدي أو سعودي درجة أولي", "خرطوم و علب ماجيك و فليكسبل مصطفي محمود", "لوحه تاسيس 18خط من نوع فينوس ", "قواطع السويدي ( هيميل )"],
    ...
    ["دفتيرفي كامل الوحده ", "مفاتيح و برايز فينوس", "تأسيس لزوم الكاميرات", "تأسيس سون سيستم في الريسبشن والطرق تاسيس سون سيستم"],
    ["تركيب كاميرا ذاكيه 200 c من تابو بزاويه 360 درجه بخاصية الواي فاي و الاماله بدقه 1080 بكسل – ابيض لا سلكي ", "تأسيس حساس اضاءه علي باب الشقه ", "تأسيس ليد بروفيل في الطرق"],
    ["تأسيس كشاف طوارئ في الريسبشن ", "تأسيس ليد مغناطيس في الريسبشن ", "تأسيس كشافات مقاومه للماء ف الريسبشن و الطرق ", "تاسيس كشافات سقف ديكور لتابلوهات "],
  ];
  ...
  const FinishingWorks = [
    ...
    ["يتم اضافه تغذيه و صرف للغساله الملابس وأطباق علي حسب رغبة العميل ", "صرف تكيفات" , "تاسيس بانيو او كابينة شور "],
    ["عمل صرف أمطار في البلكونه ", "تأسيس و صرف مكان حوض سمك أو نافوره علي حسب طلب العميل ", "تأسيس أجهزه استشعار التسرب "],
  ];

  const sections = [
    { title: "أعمال الأسقف", items: ["توريد و تركيب خامات من نوع كناوف لزوم الجبس بورد فلات لكامل الوحده ", "الاعمال تشمل تركيب الاسبوتات والليد", "كناوف اخضر للحمامات", "كناوف احمر للمطابخ"] },
    { title: "أعمال النجارة", items: ["باب شقه مستورد تركي  11 مم", "ابواب داخلية موسكي بدهان استر او دوكو او ابواب MDF  حسب طلب العميل"] },
    { title: "أعمال الدهانات", items: ["وش سيلر مائي", "2سكينة سافيتو", "4 سكاكين معجون GLC", "2 وش بطانة 70 في 70 تشطيب نهائي من شركه جوتن قابل للغسيل"] },
    { title: "أعمال الأرضيات", items: ["توريد و تركيب سيراميك كامل الريسبشن و الطرق ارضيات لا يتعدي سعر المتر 320جنية ", "توريد و تركيب سيراميك باقي الوحده ارضيات وحوائط  لا يتعدي سعر المتر 280جنية ", "توريد و تشوين الاسمنت و الرمال و ماده السقية وكل ما يخص ذلك البند"] },
    { title: "الالوميتال", items: ["PS  صغير الريسبشن و الغرف", "PS  صغير بزجاج مصنفر للحمامات و المطابخ"] },
    { title: "الديكور", items: ["عمل جنب قطيفه في حدود 5 متر او استوكا انتيكا في حدود 5 متر", "جانب بديل خشب لا يتعدي 3 متر", "عمل بانو جبس في الريسبشن و الطرقه", "عمل خلفيه 3d  في اوضه الاطفال على حسب طلب العميل"] },
      ...
      <div className="flex flex-col px-5 md:px-16">
        ...
        <div className="flex items-center justify-between cursor-pointer" onClick={() => setOpenIndex(isOpen ? null : index)}>
          <div className="text-white flex items-center space-x-1.5 text-left text-base md:text-[25px] font-semibold">
            ...
            <p>باقة</p>
            <p>Vip</p>
            <span className="text-[#21B7A6] text-xs md:text-[22px] pr-2.5">4700 جينيه</span>
          </div>
      ...
      {isOpen && (
        <div className="px-10 mt-5 space-y-6">
          ...
          <div className="mt-5 flex flex-col lg:flex-row lg:space-x-3 space-y-2 lg:space-y-0">
            <ItemWithIcon icon={verify} text="تشطيب السباكه قاعده و حوض بحد اقصي 9000 جنية للحمام الواحد بحد اقصي 2 حمام" />
            <ItemWithIcon icon={verify} text="تركيب خلاطات للحمام والمطبخ بحد اقصي 10000جنية" />
            <ItemWithIcon icon={gift} text="هدية مراية ليد في الحمام" iconWidth="w-6" />
          </div>

          {/* الأقسام الأخرى */}
          <div className="flex flex-col space-y-[20px] mt-6">
