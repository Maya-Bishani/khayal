...
const electricityWorks = [
  ...
  ,
  {
    ...
    items: [
      ...
      "2سكينة سافيتو",
      "4 سكاكين معجون GLC",
      "2 وش بطانة 70 في 70 تشطيب نهائي من شركه جوتن قابل للغسيل",
    ],
  },
  ,
  {
    ...
    items: [
      "توريد و تركيب سيراميك كامل الريسبشن و الطرق ارضيات لا يتعدي سعر المتر 320جنية ",
      "توريد و تركيب سيراميك باقي الوحده ارضيات وحوائط  لا يتعدي سعر المتر 280جنية ",
      ...
      >
       ...
       <div className="flex space-x-2 mt-5 items-center text-white " >
        ...
        <div className="flex items-center text-white space-x-1">
          <img src={verify} alt="check"/>
          <p className="text-sm md:text-base font-normal">تشطيب السباكه قاعده و حوض بحد اقصي 9000 جنية للحمام الواحد بحد اقصي 2 حمام</p>

        </div>
        <div className="flex items-center text-white space-x-1 ">
          <img src={verify} alt="check"/>
          <p className="text-sm md:text-base font-normal">تركيب خلاطات للحمام والمطبخ بحد اقصي 10000جنية</p>
        </div>
