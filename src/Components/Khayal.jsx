...
export default function Khayal({ index, openIndex, setOpenIndex }) {
  ...
  const electricityWorks = [
    ...
    ["مفاتيح و برايز فينوس", "تأسيس لزوم الكاميرات", "تأسيس سون سيستم في الريسبشن"],
    ...
    ["تأسيس ليد بروفيل في الطرق", "تأسيس كشاف طوارئ في الريسبشن"],
  ];
  ...
  const FinishingWorks = [
    ...
    ["صرف تكيفات", "تأسيس بانيو او كابينة شور", "عمل صرف امطار في البلكونه", "تأسيس و صرف مكان حوض سمك او نافوره علي حسب طلب العميل"],
  ];

  const sections = [
    { title: "أعمال الأسقف", items: ["جبس بورد فلات الريسبشن و الطرق", "للغرف بيت نور فقط النوع كناوف الصاج 4 من 10 من افضل انواع الجبس بورد"] },
    { title: "أعمال النجارة", items: ["باب شقه مستورد تركي 10 مم", "ابواب داخلية موسكي بدهان استر او دوكو او ابواب MDF حسب طلب العميل"] },
    { title: "أعمال الدهانات", items: ["وش سيلر مائي", "2 سكينة سافيتو", "4 سكاكين معجون GLC", "2 وش بطانة 30 في 30", "تشطيب نهائي من شركه جوتن قابل للغسيل"] },
    { title: "أعمال الأرضيات", items: ["توريد و تركيب سيراميك كامل الريسبشن و الطرق ارضيات لا يتعدي سعر المتر 300جنية", "توريد و تركيب سيراميك باقي الوحده ارضيات وحوائط لا يتعدي سعر المتر 250جنية", "توريد و تشوين الاسمنت و الرمال و ماده السقية وكل ما يخص ذلك البند"] },
    { title: "أعمال الالوميتال", items: ["توريد و تركيب الالوميتال PS صغير في كامل الوحده"] },
    { title: "الديكور", items: ["عمل جنب قطيفه في حدود 5 متر او استوكا انتيكا في حدود 5 متر", "عمل بانو جبس في الريسبشن و الطرقه", "عمل خلفيه 3d في اوضه الاطفال علي حسب طلب العميل"] },
      ...
      <div className="flex flex-col px-5 md:px-16">
        <div className="flex items-center justify-between">
          <p className="text-white text-left text-base md:text-[25px] font-semibold">
            0.4 باقة خيال
            <span className="text-[#21B7A6] text-xs md:text-[22px] pr-2.5">4200 جينيه</span>
          </p>
          <div
