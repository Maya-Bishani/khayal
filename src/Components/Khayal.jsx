  ...
  const FinishingWorks = [
    [
      ...
      [
          ...
          "تأسيس و صرف مكان حوض سمك او نافوره علي حسب طلب العميل "
      ],
  ...
  const sections = [
    {
      title: "أعمال الأسقف",
      items: [
        "جبس بورد فلات الريسبشن و الطرق ",
        "للغرف  بيت نور فقط النوع كناوف الصاج 4 من 10 من افضل انواع الجبس بورد ",
      ],
    },
    {
      title: "أعمال النجارة",
    ...
    },
    {
      ...
      },
      {
        ...
        items: [
          "توريد و تركيب سيراميك كامل الريسبشن و الطرق ارضيات لا يتعدي سعر المتر 300جنية ",
          "توريد و تركيب سيراميك باقي الوحده ارضيات وحوائط  لا يتعدي سعر المتر 250جنية ",
      ...
      },
    {
        ...
        items: [
          "توريد و تركيب الالوميتال PS  صغير في كامل الوحده",
        ],
      },
      ...
      >
       ...
       <div className="flex space-x-2 mt-5 items-center text-white " >
        ...
        <div className="flex items-center text-white space-x-1">
          <img src={verify} alt="check"/>
          <p className="text-sm md:text-base font-normal">تشطيب السباكه قاعده و حوض بحد اقصي 8000 جنية للحمام الواحد بحد اقصي 2 حمام </p>

        </div>
        <div className="flex items-center text-white space-x-1 ">
          <img src={verify} alt="check"/>
          <p className="text-sm md:text-base font-normal">تركيب خلاطات للحمام و المطبخ بحد اقصي 9000جنية </p>
        </div>
